...
//            return null; // replace this line with your code
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        ...
        //Create an object of TestRequest class and use the assignForLabTest() method of testRequestUpdateService
        ...
        try {
            User user = userLoggedInService.getLoggedInUser();
            TestRequest request = testRequestUpdateService.assignForLabTest(id, user);
            return request;
    ...
    public TestRequest updateLabTest(@PathVariable Long id,@RequestBody CreateLabResult createLabResult) {
        ...
        // Create an object of TestResult class and make use of updateLabTest()
        ...
        try {
            User user = userLoggedInService.getLoggedInUser();
            TestRequest request = testRequestUpdateService.updateLabTest(id, createLabResult, user);
            return request; // replace this line of code with your implementation
