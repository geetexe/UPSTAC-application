...
//        return null; // replace this line with your code
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        //Implement this method to return the list of test requests assigned to
        // current doctor(make use of the above created User object)
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        // method of testRequestUpdateService to assign the particular id to the current user
        // return the above created object
        // Refer to the method createRequest() from the TestRequestController class
        try {
            User user = userLoggedInService.getLoggedInUser();
            TestRequest request = testRequestUpdateService.assignForConsultation(id, user);
